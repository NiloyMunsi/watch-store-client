...
const ManageOrders = () => {
  ...
  useEffect(() => {
    fetch('https://obscure-shelf-77524.herokuapp.com/allOrders')
      .then(res => res.json())
  ...
  const handleOrderUpdate = id => {
    setIsLoading(true)
    fetch(`https://obscure-shelf-77524.herokuapp.com/updateOrder/${id}`, {
      method: 'PUT',
    })
      .then(res => res.json())
      .then(data => {
  ...
  const handleDeleteOrders = id => {
    ...
    fetch(`https://obscure-shelf-77524.herokuapp.com/orders/${id}`, {
      method: 'DELETE'
    })
      .then(res => res.json())
      .then(data => {
